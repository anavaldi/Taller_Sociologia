...
# Set weird symbols
discursoDelRey <- tolower(discursoDelRey)
discursoDelRey <- gsub("ã¡", "a", discursoDelRey)
discursoDelRey <- gsub("ã©", "e", discursoDelRey)
discursoDelRey <- gsub("ã³", "o", discursoDelRey)
discursoDelRey <- gsub("ãº", "u", discursoDelRey)
discursoDelRey <- gsub("ã±", "ñ", discursoDelRey)
discursoDelRey <- gsub("ã¨", "e", discursoDelRey)
discursoDelRey <- gsub("ã²", "o", discursoDelRey)
discursoDelRey <- gsub("ã", "i", discursoDelRey)
